...
class Generator extends \yii\gii\Generator
{
    ...
    private $_allBehaviors = [
        'blameable' => [
                        ...
                        'behaviours' => ["['class' => BlameableBehavior::className(),]"]
                        ],
        'timestamp' => [
        ...
        'sluggable' => [
                        ...
                        'behaviours' => ["'class' => SluggableBehavior::className(), 'attribute' => 'title',"]
                        ],
    ];
    private $_allSpecialFields = [
        'image' => [
            'includes' => ['use yii\web\UploadedFile',
                            'use \common\models\helpers\ImageManager'],
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['generateRelations', 'generateLabelsFromComments', 'useTablePrefix', 'useSchemaName', 'generateQuery', 'generateExtendedModelClass'], 'boolean'],
            [['enableI18N'], 'boolean'],
    ...
    public function generate()
    {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            $extendedModelClassFile = Yii::getAlias('@' . str_replace('\\', '/', $this->ns)) . '/' . $modelClassName . '.php';
    ...
    {
        foreach ($tableSchema->columns as $column) {
            if (strcasecmp($column->name, 'image')==0) {
                $this->_includesToGenerate = array_merge($this->_includesToGenerate,
